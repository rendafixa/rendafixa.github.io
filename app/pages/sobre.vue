  ...
  <div class="px-10">
    ...
    <div class="bg-white rounded-lg shadow-md">
      ...
      <div class="px-6 py-4 space-y-3 text-gray-700">
        <p>
          <a href="https://www.flaticon.com/free-icons/budget" rel="noopener" class="text-blue-600 hover:text-blue-800 underline">
            Budget icons created by Freepik - Flaticon
          </a>
        </p>
        <p>
          Photo by
          <a href="https://unsplash.com/@wocintechchat" rel="noopener" class="text-blue-600 hover:text-blue-800 underline">
            Christina @ wocintechchat.com
          </a>
          on
          <a href="https://unsplash.com/s/photos/dev" rel="noopener" class="text-blue-600 hover:text-blue-800 underline">
            Unsplash
          </a>
        </p>
      </div>
