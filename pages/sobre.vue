<template>
  <div>
      ...
      <v-col cols="12" sm="6">
        <v-card>
          ...
          <v-card-actions>
            ...
            >
              <v-icon>mdi-bug-outline</v-icon>Achei um bug
            </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
        ...
        <v-card>
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              href="https://github.com/rendafixa/rendafixa.github.io/graphs/contributors"
            >
              <v-icon>mdi-account-multiple</v-icon>Desenvolvedores
            </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
    ...
    <v-card>
      ...
      <v-card-text>
        <p>
          <a href="https://www.flaticon.com/free-icons/budget" rel="noopener"
            >Budget icons created by Freepik - Flaticon</a
          >
        </p>
        <p>
          Photo by
          <a href="https://unsplash.com/@wocintechchat" rel="noopener"
            >Christina @ wocintechchat.com</a
          >
          on
          <a href="https://unsplash.com/s/photos/dev" rel="noopener"
            >Unsplash</a
          >
        </p>
      </v-card-text>
